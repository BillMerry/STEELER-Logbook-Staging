...
- Generate a Lookout Request SMS with the AIS position link enabled and confirm the position search link opens in a browser on a device with the MarineTraffic app installed.
